...
function AnimatedBackground() {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      {/* Floating orbs */}
      <div className="absolute top-[10%] right-[15%] w-72 h-72 rounded-full bg-[#FFD23F]/5 blur-3xl animate-float" />
      <div className="absolute bottom-[20%] left-[10%] w-96 h-96 rounded-full bg-white/3 blur-3xl animate-float-slow" />
      <div className="absolute top-[60%] right-[5%] w-48 h-48 rounded-full bg-[#2EA77A]/5 blur-3xl animate-float-reverse" />
          ...
          <div className="w-full max-w-sm mx-auto">
            ...
            >
              <div className="w-16 h-16 rounded-2xl bg-white/15 backdrop-blur-sm mx-auto flex items-center justify-center mb-3 ring-1 ring-white/20">
                <Compass className="w-8 h-8 text-[#FFD23F]" strokeWidth={2.5} />
              </div>
            ...
            >
              {/* Login / Register Tabs */}
              {step === 'main' && (
                <div className="flex bg-[#F1F3F5] dark:bg-[#21262D] rounded-xl p-1 mb-6">
                  <button
              ...
              {error && (
                <motion.div
                  ...
                  className="bg-[#FEE2E2] dark:bg-[#3D1F1F] text-[#E63946] p-3 rounded-xl text-sm text-center mb-4"
                >
                  {error}
                </motion.div>
              )}
                ...
                <div className="space-y-4">
                  ...
                  {authMode === 'register' && (
                    <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} className="space-y-1.5">
                      <label className="text-xs font-semibold text-[#6C757D] dark:text-[#8B949E] uppercase tracking-wider">
                  ...
                  {authMode === 'register' && (
                    <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} className="space-y-1.5">
                      <label className="text-xs font-semibold text-[#6C757D] dark:text-[#8B949E] uppercase tracking-wider">
                        {sw ? 'Barua Pepe' : 'Email'} <span className="text-[#6C757D] font-normal normal-case">({sw ? 'si lazima' : 'optional'})</span>
                      </label>
                      <div className="relative">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="flex gap-2">
                      <div className="flex items-center px-3 bg-[#F1F3F5] dark:bg-[#21262D] rounded-xl text-sm font-semibold min-w-fit border border-[#E9ECEF] dark:border-[#30363D] h-11">
                        🇹🇿 +255
                      </div>
                      <Input
                        type="tel"
                  ...
                  {authMode === 'login' && (
                    <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} className="space-y-1.5">
                      <div className="flex items-center justify-between">
                        ...
                        <button className="text-xs font-medium text-[#0A4D3C] dark:text-[#2EA77A] hover:underline">
                          {sw ? 'Umesahau?' : 'Forgot?'}
                        </button>
                      </div>
                      <div className="relative">
                        <Shield className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#6C757D]" />
                        <Input
                        ...
                        <button
                          ...
                          className="absolute right-3 top-1/2 -translate-y-1/2 text-[#6C757D] hover:text-[#0A4D3C] transition-colors"
                        >
                    ...
                    <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} className="flex items-start gap-2.5">
                      <button
                        ...
                        className={`w-5 h-5 rounded-md border-2 flex items-center justify-center shrink-0 mt-0.5 transition-all ${
                          agreeTerms ? 'bg-[#0A4D3C] border-[#0A4D3C]' : 'border-[#CBD5E1] dark:border-[#30363D]'
                        }`}
                      >
                        {agreeTerms && <CheckCircle2 className="w-3 h-3 text-white" />}
                      </button>
                      <span className="text-xs text-[#6C757D] dark:text-[#8B949E] leading-relaxed">
                        {sw
                  ...
                  <div className="relative flex items-center gap-3 py-1">
                    ...
                    <span className="text-[11px] text-[#6C757D] dark:text-[#8B949E] whitespace-nowrap font-medium uppercase tracking-wider">
              ...
              {step === 'otp' && (
                <div className="space-y-4">
                  <div className="text-center mb-2">
                    <div className="w-14 h-14 rounded-2xl bg-[#E8F5EE] dark:bg-[#0D2818] mx-auto flex items-center justify-center mb-3">
                      <Phone className="w-6 h-6 text-[#0A4D3C] dark:text-[#2EA77A]" />
                    </div>
                  ...
                  <Input
                    ...
                    maxLength={6}
                  />
                  <p className="text-xs text-[#6C757D] dark:text-[#8B949E] text-center">
                  ...
                  <button onClick={() => setStep('main')} className="w-full py-2.5 rounded-xl text-sm font-medium border border-[#E9ECEF] dark:border-[#30363D] hover:bg-[#F1F3F5] dark:hover:bg-[#21262D] transition-colors">
                    {sw ? 'Rudi' : 'Go Back'}
                  </button>
                </div>
              )}
                  ...
                  <div className="space-y-3">
                    ...
                    <motion.button
                      ...
                      className={`w-full p-4 rounded-2xl text-left transition-all border-2 ${
                        selectedRole === 'seeker'
                          ? 'border-[#0A4D3C] bg-[#E8F5EE] dark:bg-[#0D2818] shadow-md'
                          : 'border-[#E9ECEF] dark:border-[#30363D] hover:border-[#0A4D3C]/30 hover:bg-[#F8F9FA] dark:hover:bg-[#21262D]'
                      }`}
                    >
                      <div className="flex items-center gap-3.5">
                        <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#FFD23F] to-[#FFA500] flex items-center justify-center shadow-sm">
                          <MapPin className="w-6 h-6 text-white" />
                        </div>
                        <div className="flex-1">
                          <div className="font-bold text-sm">{sw ? 'Mtafuta Mwongozo' : 'Market Seeker'}</div>
                          <div className="text-xs text-[#6C757D] dark:text-[#8B949E] mt-0.5">
                            {sw ? 'Tafuta mwongozo, pata bei bora, nunua kwa ujasiri' : 'Find guides, get fair prices, shop with confidence'}
                          </div>
                        </div>
                        {selectedRole === 'seeker' && (
                          <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }}>
                            <CheckCircle2 className="w-5 h-5 text-[#0A4D3C]" />
                          </motion.div>
                        )}
                      </div>
                    </motion.button>
                    ...
                    >
                      <div className="flex items-center gap-3.5">
                        <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#0A4D3C] to-[#2EA77A] flex items-center justify-center shadow-sm">
            ...
            >
              ...
              <div className="flex gap-2">
                {[
                  { role: 'seeker', icon: MapPin, color: 'from-[#FFD23F] to-[#FFA500]' },
                  { role: 'guide', icon: Compass, color: 'from-[#0A4D3C] to-[#2EA77A]' },
                  { role: 'admin', icon: Shield, color: 'from-[#8A2BE2] to-[#6D28D9]' },
      ...
      <div className="min-h-screen flex items-center justify-center auth-bg">
        ...
        <div className="relative z-10 flex flex-col items-center gap-3">
          <div className="w-12 h-12 rounded-2xl bg-white/15 backdrop-blur-sm flex items-center justify-center animate-pulse">
            <Compass className="w-6 h-6 text-[#FFD23F]" />
          </div>
          <div className="w-8 h-8 border-2 border-white/30 border-t-[#FFD23F] rounded-full animate-spin" />
        </div>
      </div>
    }>
      <AuthContent />
