...
const demoNotifications = [
  ...
  { id: 'n6', userId: 'demo', type: 'system_announcement', title: 'System Update', message: 'Chimbo Direct v2.5 is now available with improved map features.', read: false, actionUrl: '/settings', createdAt: new Date(Date.now() - 1000 * 60 * 60 * 2).toISOString() },
